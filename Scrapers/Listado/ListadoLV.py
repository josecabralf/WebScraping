...
from Scrapers.CaracteristicasStrategy import CaracteristicasStrategyLV
from Scrapers.Publicacion.PublicacionLV import PublicacionLV
...
class ListadoLV(Listado):
    ...
    def crear_publicacion(self, url: str) -> PublicacionLV:
        return PublicacionLV(url, self.strategy_soup, CaracteristicasStrategyLV.get_instance(), self._hoy, self._fecha_corte)
