from modules.format.links import formarLink, getCantPaginas
from LVConfig import URL_LaVoz, archivos_LaVoz
from modules.format.archivos import formarArchivo, asignarValNro, escribirFechaArchivo, comprimirCantArchivos
from modules.threads.hilos import scrapMultiHilo


def main():
    paginas = getCantPaginas(URL_LaVoz)
    ...
    comprimirCantArchivos(archivos_LaVoz)
